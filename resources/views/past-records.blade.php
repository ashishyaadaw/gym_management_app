...
@section('content')
        ...
        <div class="card-body">
            <div class="d-flex flex-wrap align-items-end gap-2 mb-3">
                <div>
                    ...
                    <input type="date" id="default-date" class="form-control form-control-sm" max="{{ today()->toDateString() }}">
                </div>
                <div>
    ...
    {{-- ---------- Recorded past records ---------- --}}
    <div class="card d-none" data-pane="list">
        <div class="card-body">
            <div class="row g-2 align-items-end mb-3">
                <div class="col-6 col-md-auto">
                    <label class="form-label gf-eyebrow mb-1" for="list-from">From</label>
                    <input type="date" id="list-from" class="form-control form-control-sm" max="{{ today()->toDateString() }}">
                </div>
                <div class="col-6 col-md-auto">
                    <label class="form-label gf-eyebrow mb-1" for="list-to">To</label>
                    <input type="date" id="list-to" class="form-control form-control-sm" max="{{ today()->toDateString() }}">
                </div>
...
@push('scripts')
    <script src="{{ asset('js/pages/past-records.js') }}?v={{ filemtime(public_path('js/pages/past-records.js')) }}"></script>
@endpush
