...
@section('content')
    ...
    <div class="row g-2 mb-3">
        ...
        <div class="col-12 col-lg-7">
            <div id="member-filters" class="d-flex flex-wrap gap-2">
                @foreach (['all' => 'All', 'active' => 'Active', 'expiring' => 'Expiring', 'expired' => 'Expired', 'none' => 'No plan', 'deactivated' => 'Deactivated'] as $key => $label)
    ...
    @if ($canWrite)
        ...
        {{-- One-time registration links: the new member fills in their own details and is registered without a plan --}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="invite-body">
                        <p class="small text-secondary">
                            ...
                            and expires after {{ config('gym.registration_link_hours') }} hours. Add their plan later with Renew.
                        </p>
