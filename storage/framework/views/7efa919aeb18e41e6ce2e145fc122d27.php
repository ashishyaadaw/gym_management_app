...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(in_array(auth()->user()->role, ['admin', 'receptionist'], true)): ?>
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form id="payment-form" class="row g-3 align-items-start" novalidate>
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <label class="form-label small fw-medium">Amount (<?php echo e(config('gym.currency')); ?>)</label>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/pages/billing.js')); ?>?v=<?php echo e(filemtime(public_path('js/pages/billing.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\00_LARAVEL_PROJECT\gym-management-laravel\gym-management\resources\views/billing.blade.php ENDPATH**/ ?>