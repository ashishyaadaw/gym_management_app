...
<div class="col-sm-6">
    ...
    <input name="date_of_birth" type="date" class="form-control" max="<?php echo e(today()->toDateString()); ?>">
</div>
<div class="col-12">
...
<div class="col-sm-6">
    <label class="form-label small fw-medium">How did <?php echo e($public ? 'you' : 'they'); ?> hear about us?</label>
    <select name="referral_source" class="form-select"><option value="">—</option><?php echo $opts(MemberProfile::SOURCES); ?></select>
</div>
...
<div class="col-sm-6">
    ...
    <select name="fitness_goal" class="form-select"><option value="">—</option><?php echo $opts(MemberProfile::GOALS); ?></select>
</div>
<div class="col-sm-6">
    <label class="form-label small fw-medium">Experience level</label>
    <select name="fitness_level" class="form-select"><option value="">—</option><?php echo $opts(MemberProfile::LEVELS); ?></select>
</div>
<div class="col-sm-6">
    <label class="form-label small fw-medium">Preferred workout time</label>
    <select name="preferred_timing" class="form-select"><option value="">—</option><?php echo $opts(MemberProfile::TIMINGS); ?></select>
</div>
<div class="col-sm-6">
    <label class="form-label small fw-medium">Blood group</label>
    <select name="blood_group" class="form-select">
        <option value="">—</option>
        <?php $__currentLoopData = MemberProfile::BLOOD_GROUPS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH D:\00_LARAVEL_PROJECT\gym-management-laravel\gym-management\resources\views/partials/member-profile-fields.blade.php ENDPATH**/ ?>