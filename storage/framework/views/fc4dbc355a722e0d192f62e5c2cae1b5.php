<?php $__env->startSection('title', 'POS Store'); ?>
            ...
            <div class="card position-sticky" style="top:1rem">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-baseline mb-3">
                        ...
                        <span class="fs-3 fw-bold tabular" id="cart-total"><?php echo e(config('gym.currency')); ?>0</span>
                    </div>
    ...
    <div class="card mt-3">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <span class="gf-eyebrow"><span id="sales-summary"></span> &middot; <a href="<?php echo e(route('sales')); ?>" class="text-decoration-none">All sales &amp; reports</a></span>
            </div>
                ...
                <form id="product-form" class="modal-content" novalidate>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <label class="form-label small fw-medium">Cost price (<?php echo e(config('gym.currency')); ?>)</label>
                                <input name="cost_price" type="number" min="0" step="0.01" class="form-control" required>
                            </div>
                            <div class="col-sm-6">
                                <label class="form-label small fw-medium">Selling price (<?php echo e(config('gym.currency')); ?>) *</label>
...
<?php $__env->startPush('scripts'); ?>
    <script>window.StorePage = { isAdmin: <?php echo json_encode($isAdmin, 15, 512) ?> };</script>
    <script src="<?php echo e(asset('js/pages/store.js')); ?>?v=<?php echo e(filemtime(public_path('js/pages/store.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\00_LARAVEL_PROJECT\gym-management-laravel\gym-management\resources\views/store.blade.php ENDPATH**/ ?>