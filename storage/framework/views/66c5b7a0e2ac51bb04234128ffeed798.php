...
<?php $__env->startSection('content'); ?>
    <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3 mb-4">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a class="btn btn-light d-inline-flex align-items-center gap-2" href="<?php echo e(route('staff.attendance')); ?>">
                <svg class="gf-ico gf-ico--sm"><use href="#i-clock"/></svg> Attendance
            </a>
            <a class="btn btn-light d-inline-flex align-items-center gap-2" href="<?php echo e(route('payroll')); ?>">
    ...
    <div class="row g-2 mb-3">
        ...
        <div class="col-12 col-lg-7">
            <div id="staff-filters" class="d-flex flex-wrap gap-2">
                <?php $__currentLoopData = ['all' => 'All', 'active' => 'Working', 'inactive' => 'Left / inactive', 'noprofile' => 'No profile']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" class="btn btn-light btn-sm gf-chip <?php echo e($key === 'all' ? 'active' : ''); ?>" data-filter="<?php echo e($key); ?>"><?php echo e($label); ?></button>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="weekly_off" class="form-select">
                                <?php $__currentLoopData = \App\Models\StaffProfile::DAYS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($i); ?>"><?php echo e($day); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label class="form-label small fw-medium js-salary-label">Monthly salary (<?php echo e(config('gym.currency')); ?>) *</label>
                        ...
                        <div class="col-md-4 d-flex align-items-end"><div class="form-text mb-2">Clocking in more than <?php echo e(config('gym.late_grace_minutes')); ?> min after the start is marked late.</div></div>
                        <div class="col-12">
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/pages/staff.js')); ?>?v=<?php echo e(filemtime(public_path('js/pages/staff.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\00_LARAVEL_PROJECT\gym-management-laravel\gym-management\resources\views/staff.blade.php ENDPATH**/ ?>